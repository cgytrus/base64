...
void BASE64_EXPORT base64_encode_url
	( const char		*src
	, size_t		 srclen
	, char			*out
	, size_t		*outlen
...
void BASE64_EXPORT base64_stream_encode_url
	( struct base64_state	*state
	, const char		*src
	, size_t		 srclen
	, char			*out
...
void BASE64_EXPORT base64_stream_encode_final_url
	( struct base64_state	*state
	, char			*out
	, size_t		*outlen
	) ;
...
int BASE64_EXPORT base64_decode_url
	( const char		*src
	, size_t		 srclen
	, char			*out
	, size_t		*outlen
...
int BASE64_EXPORT base64_stream_decode_url
	( struct base64_state	*state
	, const char		*src
	, size_t		 srclen
	, char			*out
